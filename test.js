...
let test = () => {
    ...
    for (let i of inputs) {
        testEqual(moment(i).format('MMM D, YYYY - h:mm a'), gnoment(i).format('MMM D, YYYY - h:mm a'));
    }   
    ...
    testHeader('moment(i).format(\'MMM D, YYYY - h:mm a\')')
    for (let i of inputs) {
        testEqual(moment(i).tz(tz).format('MM/DD/YYYY hh:mm a z'), gnoment(i).tz(tz).format('MM/DD/YYYY hh:mm a z'));
    }    

    const timezones = ['America/Los_Angeles','Europe/Paris', 'Asia/Tokyo', 'UTC'];
    for (let tz of timezones) {
        testHeader(`Testing timezone: ${tz}`);
        for (let i of inputs) {
            testEqual(String(moment.tz(i, tz)),
                      String(gnoment.tz(i, tz)));
        }
    }
    ...
    testEqual(
        ...
        gnoment('2025-01-23T07:00:00Z').isSameOrAfter(gnoment('2025-01-22T07:00:00Z'))
    );
    ...
    testEqual(String(moment('2025-01-23T07:00:00Z').subtract(1, 'day')), String(gnoment('2025-01-23T07:00:00Z').subtract(1, 'day')))

    testHeader('Date Arithmetic Tests - add')
    testEqual(String(moment('2025-01-23T07:00:00Z').add(1, 'day')), String(gnoment('2025-01-23T07:00:00Z').add(1, 'day')))

    testEqual(String(moment('2025-01-23T07:00:00Z').add(1, 'year')), String(gnoment('2025-01-23T07:00:00Z').add(1, 'year')))
    
    testEqual(String(moment('2025-01-23T07:00:00Z').add(1, 'month')), String(gnoment('2025-01-23T07:00:00Z').add(1, 'month')))

    testHeader('Date Arithmetic Tests - startOf')
    testEqual(String(moment('2025-01-23T07:00:00Z').startOf('year')), String(gnoment('2025-01-23T07:00:00Z').startOf('year')))
    testEqual(String(moment('2025-01-23T07:00:00Z').startOf('month')), String(gnoment('2025-01-23T07:00:00Z').startOf('month')))
    testEqual(String(moment('2025-01-23T07:00:00Z').startOf('day')), String(gnoment('2025-01-23T07:00:00Z').startOf('day')))

    testHeader('Date Arithmetic Tests - endOf')
    testEqual(String(moment('2025-01-23T07:00:00Z').endOf('year')), String(gnoment('2025-01-23T07:00:00Z').endOf('year')))
    testEqual(String(moment('2025-01-23T07:00:00Z').endOf('month')), String(gnoment('2025-01-23T07:00:00Z').endOf('month')))
    testEqual(String(moment('2025-01-23T07:00:00Z').endOf('day')), String(gnoment('2025-01-23T07:00:00Z').endOf('day')))
